...
__all__ = ['iresnet18_advBCT', 'iresnet34_advBCT', 'iresnet50_advBCT'，'iresnet100_advBCT'，'iresnet200_advBCT'，]
...
class IResNet(nn.Module):
    ...
    def __init__(self,
                 ...
                 groups=1, width_per_group=64, replace_stride_with_dilation=None, fp16=False, num_class=0):
        ...
        self.discriminator.add_module('d_fc1', nn.Linear(num_features, 100))
        ...
        self.eboundary = ElasticBoundary(num_class)



        nn.init.constant_(self.features.weight, 1.0)
        self.features.weight.requires_grad = False
        self.middle_neuro = 256
...
def iresnet18_advBCT(pretrained=False, progress=True, **kwargs):
    return _iresnet('iresnet18', IBasicBlock, [2, 2, 2, 2], pretrained,
                    progress, **kwargs)


def iresnet34_advBCT(pretrained=False, progress=True, **kwargs):
    return _iresnet('iresnet34', IBasicBlock, [3, 4, 6, 3], pretrained,
                    progress, **kwargs)


def iresnet50_advBCT(pretrained=False, progress=True, **kwargs):
    return _iresnet('iresnet50', IBasicBlock, [3, 4, 14, 3], pretrained,
                    progress, **kwargs)


def iresnet100_advBCT(pretrained=False, progress=True, **kwargs):
    return _iresnet('iresnet100', IBasicBlock, [3, 13, 30, 3], pretrained,
                    progress, **kwargs)


def iresnet200_advBCT(pretrained=False, progress=True, **kwargs):
